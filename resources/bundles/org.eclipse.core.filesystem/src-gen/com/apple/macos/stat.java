...
public class stat {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        UnixStat.C_INT.withName("st_dev"),
        UnixStat.C_SHORT.withName("st_mode"),
        UnixStat.C_SHORT.withName("st_nlink"),
        UnixStat.C_LONG_LONG.withName("st_ino"),
        UnixStat.C_INT.withName("st_uid"),
        UnixStat.C_INT.withName("st_gid"),
        UnixStat.C_INT.withName("st_rdev"),
        UnixStat.C_INT.withName("pad0"),
        ...
        UnixStat.C_LONG_LONG.withName("st_size"),
        UnixStat.C_LONG_LONG.withName("st_blocks"),
        UnixStat.C_INT.withName("st_blksize"),
        UnixStat.C_INT.withName("st_flags"),
        UnixStat.C_INT.withName("st_gen"),
        UnixStat.C_INT.withName("st_lspare"),
        MemoryLayout.sequenceLayout(2, UnixStat.C_LONG_LONG).withName("st_qspare")
    ).withName("stat");
    ...
    private static final OfInt pad0$LAYOUT = (OfInt)$LAYOUT.select(groupElement("pad0"));
     ...
     * }
     */
    public static final OfInt pad0$layout() {
        return pad0$LAYOUT;
    }

    private static final long pad0$OFFSET = $LAYOUT.byteOffset(groupElement("pad0"));
     ...
     * }
     */
    public static final long pad0$offset() {
        return pad0$OFFSET;
    }
     ...
     * }
     */
    public static int pad0(MemorySegment struct) {
        return struct.get(pad0$LAYOUT, pad0$OFFSET);
    }
     ...
     * }
     */
    public static void pad0(MemorySegment struct, int fieldValue) {
        struct.set(pad0$LAYOUT, pad0$OFFSET, fieldValue);
    }
    ...
    private static final long st_atimespec$OFFSET = $LAYOUT.byteOffset(groupElement("st_atimespec"));
    ...
    private static final long st_mtimespec$OFFSET = $LAYOUT.byteOffset(groupElement("st_mtimespec"));
    ...
    private static final long st_ctimespec$OFFSET = $LAYOUT.byteOffset(groupElement("st_ctimespec"));
    ...
    private static final long st_flags$OFFSET = $LAYOUT.byteOffset(groupElement("st_flags"));
    ...
    private static final long st_gen$OFFSET = $LAYOUT.byteOffset(groupElement("st_gen"));
    ...
    private static final long st_lspare$OFFSET = $LAYOUT.byteOffset(groupElement("st_lspare"));
    ...
    private static final long st_qspare$OFFSET = $LAYOUT.byteOffset(groupElement("st_qspare"));
